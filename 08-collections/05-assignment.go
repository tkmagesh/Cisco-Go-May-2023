...
func main() {
	...
	*/
	...
	wordsCountBySize := getWordStats(str)
	maxCount, maxSize := getMaxStats(wordsCountBySize)
	fmt.Printf("%d letter words occurs the most with %d occurances\n", maxSize, maxCount)
}

func getWordStats(str string) map[int]int {
...
func getMaxStats(wordsCountBySize map[int]int) (maxCount, maxSize int) {
